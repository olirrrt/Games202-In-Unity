...
public class SSGIPass : ScriptableRenderPass
{
    ...
    readonly int matrixInvPID = Shader.PropertyToID("_my_matrixInvP");
    ...
    public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        material.SetMatrix(matrixInvPID, Matrix4x4.Inverse(GL.GetGPUProjectionMatrix(Camera.main.projectionMatrix, true)));
        ...
        material.SetFloat(thicknessID, passSettings.Thickness);
